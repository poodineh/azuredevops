...
namespace API.CoverletTests
{
    public class CovWeatherForecastControllerTests
    {
        [Test]
        public void CovWeatherController_ReturnAsIEnumerable_WithFiveResults()
        {
            // Arrange
        ...
        [Test]
        public void CovWeatherController_WeatherForecastSummary_ReturnsNotStringEmpty()
        {
            //Arrange
            var mockLogger = new Mock<ILogger<WeatherForecastController>>();
            mockLogger.Setup(logger => logger.IsEnabled(LogLevel.None));
